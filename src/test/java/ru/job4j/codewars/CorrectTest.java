...
public class CorrectTest {
    ...
    public void testSomething() {
        ...
        assertEquals("ERNEST HEMINGWAY - A FARWELL TO ARMS",
        ...
        assertEquals("J. D. SALINGER - THE CATCHER IN THE RYE",
        ...
        assertEquals("URSULA K. LE GUIN - THE TOMBS OF ATUAN",
                Correct.correct(Correct.correct("UR5ULA K. LE GU1N - THE T0MB5 0F ATUAN")));
        assertEquals("URSULA K. LE GUIN - THE FARTHEST SHORE",
                Correct.correct(Correct.correct("UR5ULA K. LE GU1N - THE FARTHE5T 5H0RE")));
        assertEquals("URSULA K. LE GUIN - TALES FROM EARTHSEA",
